...
function LoginForm() {
    ...
    // removed: getRedirectResult useEffect — not needed with popup
    // removed: localStorage — Firebase manages session automatically
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isExtensionAuth && extensionId) {
                ...
                router.push("/dashboard"); // Firebase session auto-persists, no localStorage needed
            }
        } catch (err: any) {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gray-50">
            <Card className="w-full max-w-md">
                <CardHeader>
                    <CardTitle>{isExtensionAuth ? "Login to Extension" : "Login"}</CardTitle>
                    <CardDescription>
                        {isExtensionAuth
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <>
                            ...
                            <p className="text-center text-sm text-gray-600">
                                ...
                                <Link
                                    href={isExtensionAuth ? `/register?ext=${extensionId}` : "/register"}
